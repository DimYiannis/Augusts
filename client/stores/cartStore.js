...
export const useCartStore = defineStore("cart", {
  ...
  actions: {
    async fetchCartItems() {
      ...
      try {
        const response = await axios.get("https://augusts.onrender.com/api/v1/cart", {
    ...
    async order() {
      ...
      try {
        ...
        const response = await axios.post(
          "https://augusts.onrender.com/api/v1/orders",
          payload,
          { withCredentials: true }
        );
    ...
    async addToCart(item) {
      ...
      try {
        ...
        const response = await axios.post(
          "https://augusts.onrender.com/api/v1/cart",
          payload,
          { withCredentials: true }
        );
    ...
    async removeCartItem(itemId) {
      ...
      try {
        ...
        await axios.delete(`https://augusts.onrender.com/api/v1/cart/${itemId}`, {
          withCredentials: true,
        });
    ...
    async patchCart(itemId) {
      ...
      try {
        ...
        const response = await axios.patch(
          `https://augusts.onrender.com/api/v1/cart/${itemId}`,
