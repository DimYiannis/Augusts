<template>
    <div class="invbackdrop" @click.self="closeLogout">
        ...
        <div class="place-self-center flex flex-col justify-self-center  
        h-screen w-screen tablet:mt-5 tablet:w-fit laptop:w-fit
        tablet:h-fit rounded-md overflow-y-scroll tablet:mx-5
        tablet:overflow-y-hidden overscroll-none border-2 
        border-[#363636] opacity-90 absolute" >    

            <div class="grid w-full h-full bg-[#363636] gap-0 
            rounded-md">
                ...
                <div class="grid tablet:flex items-center justify-center 
                space-x-6 text-white font-italic text-center
                font-semibold text-xl place-self-center my-2 mx-4
                border-t-2 border-neutral-600 ">
                    ...
                    <button class="btn">
                        <svg xmlns="http://www.w3.org/2000/svg" 
                        width="32" height="32" viewBox="0 0 24 24">
                        <path fill="none" stroke="currentColor" d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2m-6.99 15c-.7 0-1.26-.56-1.26-1.26c0-.71.56-1.25 1.26-1.25c.71 0 1.25.54 1.25 1.25c-.01.69-.54 1.26-1.25 1.26m3.01-7.4c-.76 1.11-1.48 1.46-1.87 2.17c-.16.29-.22.48-.22 1.41h-1.82c0-.49-.08-1.29.31-1.98c.49-.87 1.42-1.39 1.96-2.16c.57-.81.25-2.33-1.37-2.33c-1.06 0-1.58.8-1.8 1.48l-1.65-.7C9.01 7.15 10.22 6 11.99 6c1.48 0 2.49.67 3.01 1.52c.44.72.7 2.07.02 3.08"/></svg>
